            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Editar Partido</h1>
                        ...
                        <form action="{{ route('admin.game.update', $game->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-4
                                    ...
                                    <input type="date" name="date" class="form-control" id="date"
                                        placeholder="Fecha" value="{{ old('date') ?? $game->date }}">
                                    @error('date')
                                    ...
                                    <select name="local_team_id" class="form-control" id="local_team_id">
                                        ...
                                        @foreach ($teams as $team)
                                            <option value="{{ $team->id }}"
                                                {{ (old('local_team_id') ?? $game->local_team_id) == $team->id ? 'selected' : '' }}>
                                                {{ $team->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                    ...
                                    <select name="scorer_id" class="form-control" id="scorer_id">
                                        ...
                                        @foreach ($tableOfficials as $tableOfficial)
                                            <option value="{{ $tableOfficial->id }}"
                                                {{ (old('scorer_id') ?? $game->scorer_id) == $tableOfficial->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-6 @error('timer_id') has-error @enderror">
                                    ...
                                    <select name="timer_id" class="form-control" id="timer_id">
                                        ...
                                        @foreach ($tableOfficials as $tableOfficial)
                                            <option value="{{ $tableOfficial->id }}"
                                                {{ (old('timer_id') ?? $game->timer_id) == $tableOfficial->id ? 'selected' : '' }}>
                                                {{ $tableOfficial->name . ' ' . $tableOfficial->surname }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-6 @error('shot_clock_operator_id') has-error @enderror">
                                    ...
                                    <select name="shot_clock_operator_id" class="form-control" id="shot_clock_operator_id">
                                        ...
                                        @foreach ($tableOfficials as $tableOfficial)
                                            <option value="{{ $tableOfficial->id }}"
                                                {{ (old('shot_clock_operator_id') ?? $game->shot_clock_operator_id) == $tableOfficial->id ? 'selected' : '' }}>
                                                {{ $tableOfficial->name . ' ' . $tableOfficial->surname }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-6 @error('assistant_scorer_id') has-error @enderror">
                                    ...
                                    <select name="assistant_scorer_id" class="form-control" id="assistant_scorer_id">
                                        ...
                                        @foreach ($tableOfficials as $tableOfficial)
                                            <option value="{{ $tableOfficial->id }}"
                                                {{ (old('assistant_scorer_id') ?? $game->assistant_scorer_id) == $tableOfficial->id ? 'selected' : '' }}>
                                                {{ $tableOfficial->name . ' ' . $tableOfficial->surname }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-3
                                    ...
                                    <input type="hidden" name="scorer_travels" value="0"> <!-- Campo oculto -->
                                    <input type="checkbox" name="scorer_travels" id="scorer_travels" value="1"
                                        {{ old('scorer_travels', $game->scorer_travels) ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-3
                                    ...
                                    <input type="hidden" name="timer_travels" value="0"> <!-- Campo oculto -->
                                    <input type="checkbox" name="timer_travels" id="timer_travels" value="1"
                                        {{ old('timer_travels', $game->timer_travels) ? 'checked' : '' }}>
                                    @error('timer_travels')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div
                                    ...
                                    <input type="hidden" name="shot_clock_operator_travels" value="0"> <!-- Campo oculto -->
                                    <input type="checkbox" name="shot_clock_operator_travels"
                                        id="shot_clock_operator_travels" value="1"
                                        {{ old('shot_clock_operator_travels', $game->shot_clock_operator_travels) ? 'checked' : '' }}>
                                ...
                                <div
                                    ...
                                    <input type="hidden" name="assistant_scorer_travels" value="0"> <!-- Campo oculto -->
                                    <input type="checkbox" name="assistant_scorer_travels" id="assistant_scorer_travels"
                                        value="1" {{ old('assistant_scorer_travels', $game->assistant_scorer_travels) ? 'checked' : '' }}>
